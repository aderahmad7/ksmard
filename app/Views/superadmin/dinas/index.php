            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="kodedinas" id="kodedinas">

                        <div class="form-group col-lg-12 col-md-12 mb-3">
                            <small class="fw-semibold">Provinsi</small>
                            <span class="help"></span>
                            <div class="controls">
                                <?php echo form_dropdown('dinKode', $provinsi, '', 'id="dinKode" class="form-select form-control wide"'); ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#table-grid').DataTable({
                ...
                pagingType: 'numbers',
                ajax: {
                    url: '<?php echo site_url('superadmin/dinas/grid'); ?>',
                },
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            console.log(row);
                            const accUsername = row.accUsername;
                            const dinKode = row.roleKodeDinas;

                            var edit = '<a data-id="' + accUsername + '" style="margin :0px 1px 0px 0px ;" onclick="edit($(this));return false;" href="#" title="Ubah" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>';
                            var hapus = '<a data-id="' + accUsername + '" data-dinKode="' + dinKode + '" style="margin :0px 0px 0px 0px ;" data-bs-backdrop="static" data-bs-toggle="modal" data-bs-target="#modal-hapus" onclick="return setModalHapus($(this),\'' + accUsername + '\');" href="#" title="Hapus" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a> ';
                            return edit + hapus;
                        }
                    },
                ]
        ...
        function edit(obj) {
            ...
            $.ajax({
                url: "<?php echo base_url('superadmin/dinas/edit'); ?>",
                data: {
                    accUsername: id
                },
                type: "POST",
                ...
                success: function(response) {
                    ...
                    if (response.edit) {
                        ...
                        let selectedValue = JSON.stringify({
                            ...
                            dinProvinsi: response.data.dinProvinsi
                        });
        ...
        function hapus() {
            var id = id_delete;
            $.ajax({
                url: "<?php echo base_url('superadmin/dinas/hapus'); ?>",
                data: {
                    'id': id,
                    'id_dinas': id_dinas
                },
        ...
        $(document).delegate('.simpan', 'click', function(e) {
            ...
            $("#kode").val('');
            $.ajax({
                url: "<?php echo site_url("superadmin/dinas/simpan"); ?>",
                data: data,
                type: "POST",
                dataType: "JSON",
                beforeSend: function() {
