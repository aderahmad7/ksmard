                        ...
                        <div class="table-responsive">
                            <table class="table" id="table-grid" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th width="1%">NO</th>
                                        <th width="45%">KATEGORI PENGOLAHAN</th>
                                        <th width="45%">SUB KATEGORI PENGOLAHAN</th>
                                        <th width="9%">AKSI</th>
                                    </tr>
                                </thead>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <input type="hidden" name="katolahKode" id="katolahKode">

                        <div class="form-group col-lg-12 col-md-12 mb-3">
                            <small class="fw-semibold">Nama Kategori</small>
                            <span class="help"></span>
                            <div class="controls">
                                <?php echo form_input('katolahNama', '', 'id="katolahNama" class="form-control"'); ?>
                            </div>
                        </div>
                        <div class="form-group col-lg-12 col-md-12 mb-3">
                            <small class="fw-semibold">Nama Sub Kategori</small>
                            <span class="help"></span>
                            <div class="controls">
                                <?php echo form_input('katolahSubNama', '', 'id="katolahSubNama" class="form-control"'); ?>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#table-grid').DataTable({
                ...
                pagingType: 'numbers',
                ajax: {
                    url: '<?php echo site_url('superadmin/pengolahan/grid'); ?>',
                },
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            console.log(row);
                            const katolahKode = row.katolahKode;

                            var edit = '<a data-id="' + katolahKode + '" style="margin :0px 1px 0px 0px ;" onclick="edit($(this));return false;" href="#" title="Ubah" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>';
                            var hapus = '<a data-id="' + katolahKode + '" style="margin :0px 0px 0px 0px ;" data-bs-backdrop="static" data-bs-toggle="modal" data-bs-target="#modal-hapus" onclick="return setModalHapus($(this),\'' + katolahKode + '\');" href="#" title="Hapus" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a> ';
                            return edit + hapus;
                        }
                    },
                ]
        ...
        function setModalSimpan() {
            ...
            $("#btn-simpan").show();
            $("#modal-form .modal-title").html("Tambah Kategori Pengolahan");
        }
        ...
        function edit(obj) {
            ...
            $.ajax({
                url: "<?php echo base_url('superadmin/pengolahan/edit'); ?>",
                data: {
                    katolahKode: id
                },
                type: "POST",
                ...
                beforeSend: function() {
                    ...
                    $(".box-msg").hide();
                    $("#modal-form .modal-title").html("Edit Kategori Pengolahan");
                    $(".fa-spinner").show();
                ...
                success: function(response) {
                    ...
                    if (response.edit) {
                        // Isi field sesuai data kategori pengolahan
                        $("#katolahKode").val(response.data.katolahKode);
                        $("#katolahNama").val(response.data.katolahNama);
                        $("#katolahSubNama").val(response.data.katolahSubNama);
        ...
        function setModalHapus(dom, x) {
            ...
            $("#modal-hapus .modal-header").html("Hapus Kategori Pengolahan");
            $("#modal-hapus .modal-body").html("Anda yakin menghapus kategori pengolahan \"<span id='id-delete'></span>\"?");
            $("#id-delete").html(x);
        }
        ...
        function hapus() {
            var id = id_delete;
            $.ajax({
                url: "<?php echo base_url('superadmin/pengolahan/hapus'); ?>",
                data: {
                    'id': id
                },
                type: "POST",
        ...
        $(document).delegate('.simpan', 'click', function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url("superadmin/pengolahan/simpan"); ?>",
                data: data,
                type: "POST",
                dataType: "JSON",
                beforeSend: function() {
