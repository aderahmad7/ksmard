            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="pksKode" id="pksKode">


                        <div class="form-group col-lg-12 col-md-12 mb-3">
                            <small class="fw-semibold">Kode</small>
                            <span class="help"></span>
                            <div class="controls">
                                <?php echo form_input('pks', '', 'id="pks" class="form-control"'); ?>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#table-grid').DataTable({
                ...
                pagingType: 'numbers',
                ajax: {
                    url: '<?php echo site_url('dinas/pks/grid'); ?>',
                },
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            var hapus = '<a data-id="' + accUsername + '" data-pksKode="' + pksKode + '" style="margin :0px 0px 0px 0px ;" data-bs-backdrop="static" data-bs-toggle="modal" data-bs-target="#modal-hapus" onclick="return setModalHapus($(this),\'' + accUsername + '\');" href="#" title="Hapus" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a> ';
                            return edit + hapus;
        ...
        function edit(obj) {
            ...
            $.ajax({
                url: "<?php echo base_url('dinas/pks/edit'); ?>",
                data: {
                    accUsername: id
                },
                type: "POST",
                ...
                success: function(response) {
                    ...
                    if (response.edit) {
                        $("#pksKode").val(response.data.pksKode);
        ...
        function hapus() {
            var id = id_delete;
            $.ajax({
                url: "<?php echo base_url('dinas/pks/hapus'); ?>",
                data: {
                    'id': id,
                    'id_pks': id_pks
                },
        ...
        $(document).delegate('.simpan', 'click', function(e) {
            ...
            $("#pksKode").val('');
            $.ajax({
                url: "<?php echo site_url("dinas/pks/simpan"); ?>",
                data: data,
                type: "POST",
                dataType: "JSON",
                beforeSend: function() {
