	...
	<div class="content-body">
		...
		<div class="container-fluid">
			<div class="d-flex align-items-center justify-content-between mb-3">
				<h4 class="card-title col-sm-6">Pengangkutan</h4>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-6 col-md-6 mb-3">
							...
							<span class="help"></span>
							<div class="controls">
								<?php echo form_dropdown('angIsEkspor', $katJual, '', 'id="angIsEkspor" class="form-select   form-control wide"'); ?>
						...
						<div class="form-group col-lg-6 col-md-6 mb-3">
							...
							<span class="help"></span>
							<div class="controls">
								<?php echo form_dropdown('angTbsKode', $katTbs, '', 'id="angTbsKode" class="form-select   form-control wide"'); ?>
