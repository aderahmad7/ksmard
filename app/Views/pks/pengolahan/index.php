...
<div class="page-content">
	...
	<div class="modal fade" id="modal-sales-report">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">Laporan Pengolahan</div>
				<div class="modal-body">
					<h4>Laporan Biaya Pengolahan</h4>
					<ul class="list-group mb-3">
						
						<li class="list-group-item d-flex justify-content-between lh-condensed">
							<div>
								<h6 class="my-0">Total Biaya Pengolahan</h6>
								<small class="text-muted">Harga Rp dari jumlah seluruh biaya pengolahan</small>
							</div>
							<span class="text-muted" id="rekap-olah-total">0</span>
						</li>
						<li class="list-group-item d-flex justify-content-between lh-condensed">
							<div>
								<h6 class="my-0">Biaya per Kg</h6>
								<small class="text-muted">Harga Rp/Kg dari biaya pengolahan</small>
							</div>
							<span class="text-muted" id="rekap-olah-perkg">0</span>
						</li>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Biaya Pengolahan</h5>
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="form-group col-lg-12 col-md-6 mb-3">
							<small class="fw-semibold">Uraian Biaya</small>
						...
						<div class="form-group col-lg-12 col-md-12 mb-3">
							...
							<span class="help"></span>
							<div class="controls">
								<?php echo form_dropdown('olahKatolahKode', $kategoriPengolahan, '', 'id="olahKatolahKode" class="nice-select default-select form-control wide"'); ?>
	...
	<script>
		...
		function setModalSalesReport() {
			...
			$.ajax({
				url: "<?php echo base_url('pks/pengolahan/rekap'); ?>",
				data: {
				...
				success: function(response) {
					if (response.rekap) {
						$("#rekap-olah-total").html(formatRibuan(response.data.rekap_olah_total));
						$("#rekap-olah-perkg").html(formatRibuan(response.data.rekap_olah_perkg));
		...
		function getPeriode() {
			...
			$.ajax({
				url: "<?php echo base_url('pks/pengolahan/periode'); ?>",
				data: {
					periode: $("#indkKode").val()
				},
				type: "POST",
