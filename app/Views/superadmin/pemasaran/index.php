                        ...
                        <div class="table-responsive">
                            <table class="table" id="table-grid" style="width: 100%;">
                                <thead>
                                    <tr>
                                        <th width="1%">NO</th>
                                        <th width="90%">KATEGORI PEMASARAN</th>
                                        <th width="9%">AKSI</th>
                                    </tr>
                                </thead>
                            </table>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <input type="hidden" name="katpsrKode" id="katpsrKode">

                        <div class="form-group col-lg-12 col-md-12 mb-3">
                            <small class="fw-semibold">Nama Kategori</small>
                            <span class="help"></span>
                            <div class="controls">
                                <?php echo form_input('katpsrNama', '', 'id="katpsrNama" class="form-control"'); ?>
                            </div>
                        </div>
                    </div>
                    <?php echo form_close(); ?>
    ...
    <script>
        ...
        $(document).ready(function() {
            oTable = $('#table-grid').DataTable({
                ...
                pagingType: 'numbers',
                ajax: {
                    url: '<?php echo site_url('superadmin/pemasaran/grid'); ?>',
                },
                ...
                columns: [{
...

                    {
                        ...
                        render: function(data, type, row) {
                            console.log(row);
                            const katpsrKode = row.katpsrKode;

                            var edit = '<a data-id="' + katpsrKode + '" style="margin :0px 1px 0px 0px ;" onclick="edit($(this));return false;" href="#" title="Ubah" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>';
                            var hapus = '<a data-id="' + katpsrKode + '" style="margin :0px 0px 0px 0px ;" data-bs-backdrop="static" data-bs-toggle="modal" data-bs-target="#modal-hapus" onclick="return setModalHapus($(this),\'' + katpsrKode + '\');" href="#" title="Hapus" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a> ';
                            return edit + hapus;
                        }
                    },
                ]
        ...
        function edit(obj) {
            ...
            $.ajax({
                url: "<?php echo base_url('superadmin/pemasaran/edit'); ?>",
                data: {
                    katpsrKode: id
                },
                type: "POST",
                ...
                beforeSend: function() {
                    ...
                    $(".box-msg").hide();
                    $("#modal-form .modal-title").html("Edit Kategori Pemasaran");
                    $(".fa-spinner").show();
                ...
                success: function(response) {
                    ...
                    if (response.edit) {
                        ...
                        $("#katpsrKode").val(response.data.katpsrKode);
                        $("#katpsrNama").val(response.data.katpsrNama);
        ...
        function setModalHapus(dom, x) {
            ...
            $("#modal-hapus .modal-header").html("Hapus Kategori Pemasaran");
            $("#modal-hapus .modal-body").html("Anda yakin menghapus kategori pemasaran \"<span id='id-delete'></span>\"?");
            $("#id-delete").html(x);
        }
        ...
        function hapus() {
            var id = id_delete;
            $.ajax({
                url: "<?php echo base_url('superadmin/pemasaran/hapus'); ?>",
                data: {
                    'id': id
                },
                type: "POST",
        ...
        $(document).delegate('.simpan', 'click', function(e) {
            ...
            $.ajax({
                url: "<?php echo site_url("superadmin/pemasaran/simpan"); ?>",
                data: data,
                type: "POST",
                dataType: "JSON",
                beforeSend: function() {
