$(function() {
  ...
  if($('#monthlySalesChartRTL').length) {
    var options = {
      ...
      series: [{
        name: 'Sales',
        data: [90.4,91.01,89.89,89.50,0,0,0,0,0,0,0,0]
      }],
      xaxis: {
        type: 'text',
        categories: ['Jan 2025','Feb 2025',' Mar 2025','Apr 2025','Mei 2025','Jun 2025','Jul 2025','Agt 2025','Sep 2025','Okt 2025','Nov 2025','Des 2025'],
        axisBorder: {
          color: colors.gridBorder,
        },
        axisTicks: {
      ...
      yaxis: {
        opposite: true,
        title: {
          text: 'Nilai Indeks K Perusahaan',
          offsetX: -100,
          style:{
            size: 9,
            color: colors.muted
